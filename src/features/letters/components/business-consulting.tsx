...
export function getBusinessConsultingEmailMessage({
  firstName,
}: {
  firstName: string;
}) {
    ...
    body: `
      <section class="layout">
        <header class="header">
          ...
          <img class="img" src="https://i.ibb.co/Y4Wxf6RN/business.png" alt='header-img' />
        </header>
        <section class="main">
          <section style="padding: 40px">
            <h2 class="mainHeading">Your Custom Business Consulting Solution Request Received</h2>
            <strong  class="strong" style="margin-top: 28px">Dear ${firstName},</strong>
            <p class="paragraph">Thank you for contacting <strong class="strong">Wanmark Global</strong>. We've successfully received your request for a <strong class="strong">custom business consulting solution</strong>, and our team is already working on it.</p>
